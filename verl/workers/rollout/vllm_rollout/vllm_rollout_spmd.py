...
class vLLMRollout(BaseRollout):
    ...
    def generate_sequences(self, prompts: DataProto, **kwargs) -> DataProto:
        ...
        with self.update_sampling_params(**kwargs):
            ...
            response = []
            rollout_log_probs = []
            finish_reasons = []  # Track finish reason for each response
            ...
            # Store finish_reasons in non_tensor_batch for reward computation
            # finish_reason is "stop" if EOS reached, "length" if max length reached
            non_tensor_batch["finish_reasons"] = np.array(finish_reasons, dtype=object)
