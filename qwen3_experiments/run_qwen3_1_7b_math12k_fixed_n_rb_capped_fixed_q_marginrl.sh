...
export MAXRL_ADVANTAGE_ESTIMATOR=fixed_n_rb_capped_fixed_q_cost_aware_marginrl
...
export MAXRL_FIXED_Q_HAT=${MAXRL_FIXED_Q_HAT:-2.0}
export MAXRL_EXPERIMENT_NAME=${MAXRL_EXPERIMENT_NAME:-fixed_n_rb_capped_fixed_q2_cost_aware_marginrl_Qwen3-1.7B-Base_math12k_cap4_${LOSS_AGG_TAG}}
