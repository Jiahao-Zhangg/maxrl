...
# Qwen3-1.7B-Base on Math12K with cross-context f_cov and cost=L+256.
...
export MAXRL_ADVANTAGE_ESTIMATOR=f_cov
...
export MAXRL_EXPERIMENT_NAME=${MAXRL_EXPERIMENT_NAME:-f_cov_Qwen3-1.7B-Base_math12k_offset${MAXRL_COST_OFFSET_TOKENS}_${LOSS_AGG_TAG}}
